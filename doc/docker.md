...
The same container can be used for connecting to the Databroker:

```console
docker run  --net=host -e LOG_LEVEL=INFO can-provider:latest
```
...
## KUKSA Databroker Authentication when using Docker
